...
console.log(response.data)
  ...
  return (
   <div className="relative h-screen w-screen overflow-hidden" >
    ...
    <div ref={vehiclePanelRef} className="fixed bottom-0 z-10 px- py-12 bg-white w-full translate-y-full" >
    ...
    <div ref={confirmRidePanelRef} className="fixed bottom-0 z-10 px-3 py-12  bg-white w-full translate-y-full" >
    ...
    <div ref={vehicleFoundRef} className="fixed bottom-0 z-10 px-3 py-12 bg-white w-full translate-y-full" >
      <LookingForDriver 
      setVehicleFound={setVehicleFound}
      vehicleType={vehicleType}
      pickup={pickup}
    ...
    <div ref={waitingForDriverRef} className="fixed bottom-0 z-10 px-3 py-12 bg-white w-full translate-y-full" >
